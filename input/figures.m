...
classdef figures
    ...
    properties (Constant)
        ...
        statlimits = [5,1,1,1,1,1,3,3,5,1,1,1,3,3,5]; % Stats min and max
        difflimits = [5,1,1,1,1,1,1,1,.3,1,1,1,1,1,.3]; % Stats min and max for differences
        varnames = ["Price - Cost (short run)", "Below Cost Pricing (short run)", ...
            "Entry Probability (short run)", "Exit Probability (short run)", ...
            "Merger Probability (short run)", "Bundling Probability (short run)", ...
