...
classdef figures
    ...
    properties (Constant)
        ...
        statlimits = [3,1,1,1,1,3,3,5,1]; % Stats min and max
        difflimits = [3,1,1,1,1,1,1,.5,1]; % Stats min and max for differences
        varnames = ["Price - Cost (short run)", "Below Cost Pricing (short run)", ...
            ...
            "Total Profits (long run)", "Consumer Surplus (long run)", ...
            "Total Welfare (long run)", "Monopoly Probability (long run)"];
