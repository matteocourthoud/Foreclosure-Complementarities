...
game2 = lbd.solve_game(init.model(policy="nomergers", alpha=alpha, gamma=gamma, sigma=sigma, v0=v0));
#game3 = predatory.solve_game(init.model(policy="nopredexitbundling", alpha=alpha, gamma=gamma, sigma=sigma, v0=v0));
#game4 = predatory.solve_game(init.model(policy="nopredexitpricing", alpha=alpha, gamma=gamma, sigma=sigma, v0=v0));
